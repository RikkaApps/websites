...
::: details 為什麼<b>必須</b>要求應用程式開發者做出改變？

在 Android 11 中，對於目標 API 是 30（即 Android 11）<sup>**〔1〕**</sup>，`Android` 資料夾是真正的私有資料夾。即使有儲存權限，應用程式也只能訪問其中屬於自己的部分。
...
<sub>**〔1〕** 根據往年經驗，Google Play 會在新系統釋出一年後強制要求應用程式將目標 API 版本提升到最新版本系統（已釋出且不更新的應用程式除外）。</sub>
:::
