...
::: details 为什么<b>必须</b>要求应用开发者做出改变？

在 Android 11 中，对于目标 API 是 30（即 Android 11）<sup>**〔1〕**</sup>，`Android` 文件夹是真正的私有文件夹。即使有存储权限，应用也只能访问其中属于自己的部分。
...
<sub>**〔1〕** 根据往年经验，Google Play 会在新系统发布一年后强制要求应用将目标 API 版本提升到最新版本系统（已发布且不更新的应用除外）。</sub>
:::
